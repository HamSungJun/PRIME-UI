...
$radio-shapes: ("rect", $radius-rect), ("circle", $radius-circle);
...
.pui-radio {
  ...
  @each $theme, $label-border-color, $circle-border-color,
    $circle-background-color, $circle-inner-background-color, $label-color,
    $label-selected-color, $radio-hover-color in $radio-themes
  {
